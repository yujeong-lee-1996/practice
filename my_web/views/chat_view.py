...
from utils.rag_utils import load_vectorstore, generate_rag_answer
from dotenv import load_dotenv

# chat_bp = Blueprint("chatbot", __name__, url_prefix="/api")
chat_bp = Blueprint("chatbot", __name__, url_prefix="/project/chatbot")
